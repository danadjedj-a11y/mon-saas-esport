    ...
    <DashboardLayout session={session}>
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center border-b border-white/10 pb-5 mb-8">
          <div>
            <button
              ...
              className="px-4 py-2 bg-transparent border border-white/20 text-white rounded-full font-display text-sm uppercase tracking-wide transition-all duration-300 hover:border-[#00F5FF]/50 hover:text-[#00F5FF] mb-3"
            >
              ← Retour
            </button>
            <h1 className="font-display text-4xl text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-cyan-400 m-0">{tournoi.name}</h1>
          </div>
        ...
        {shouldShowAdminFeatures && tournoi.status === 'draft' && (
          <GlassCard className="border-l-4 border-purple-500 mb-8">
