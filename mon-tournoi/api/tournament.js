...
export default async function handler(req, res) {
  ...
  // Format attendu: api, tournament, {id}, {endpoint}
  if (pathParts.length !== 4 || pathParts[0] !== 'api' || pathParts[1] !== 'tournament') {
    return res.status(404).json({ error: 'Route non trouvée. Format attendu: /api/tournament/{id}/{endpoint}' });
  }
